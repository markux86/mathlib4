...
/-- Pick the representation of the unordered pair. -/
theorem out_eq_mk (e : Sym2 α) : e = s(e.out.1, e.out.2) := by
  rw [Sym2.mk, e.out_eq]

/-- Pick the other representation of the unordered pair. -/
theorem out_eq_mk' (e : Sym2 α) : e = s(e.out.2, e.out.1) := by
  rw [eq_swap]
  exact e.out_eq_mk
...
theorem card_toFinset_of_isDiag [DecidableEq α] (z : Sym2 α) (h : z.IsDiag) :
  ...
  rw [z.out_eq_mk, Sym2.toFinset_mk_eq]
  rw [z.out_eq_mk, Sym2.mk_isDiag_iff] at h
  simp [h]
